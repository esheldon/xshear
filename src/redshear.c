...
int main(int argc, char** argv) {
    ...
    Lensum* lensum = lensum_new(config->nbin, config->shear_style, config->scstyle, config->shear_units);
    Lensum* lensum_tot = lensum_new(config->nbin, config->shear_style, config->scstyle, config->shear_units);
